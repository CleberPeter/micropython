...
STATIC mp_obj_t uecc_add_ints(mp_obj_t a_obj, mp_obj_t b_obj) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(uecc_add_ints_obj, uecc_add_ints);
...
STATIC const mp_rom_map_elem_t mp_module_uecc_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_add_ints), MP_ROM_PTR(&uecc_add_ints_obj) },
};
